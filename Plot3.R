## myPlot3 builds the plot3.png acording to assignment
...
## myPlot3() is the main function that builds the plot according to the assignment
...
myPlot3 <- function () {
	...
	## Plot 3 combines three different linear plots of different color and legend
